        ...
        <form action="../control/formulario.php" method="get" name="formulario" id="formulario">
            <table>
                <tr>
                    ...
                    <td><input class="form-input" name="nombre" id="nombre" type="text"><div id="error-nombre"></div><br></td>
                </tr>
                <tr>
                    <td class="form-tag">Apellido:</td>
                    <td><input class="form-input" name="apellido" id="apellido" type="text"><div id="error-apellido"></div><br></td>
                </tr>
                <tr>
                    <td class="form-tag">Edad:</td>
                    <td><input class="form-input" name="edad" id="edad" type="number" value="0"><div id="error-edad"></div><br></td>
                </tr>
                <tr>
                    <td class="form-tag">Dirección:</td>
                    <td><input class="form-input" name="direccion" id="direccion" type="text"><div id="error-direccion"></div> <br></td>
                </tr>
                <tr>
